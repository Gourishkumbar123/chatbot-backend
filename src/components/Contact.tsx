      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                <Mail className="text-sky-600 mr-3" size={20} />
                <span>info@vatechventures.com</span>
              </div>
              <div className="flex items-center">
                <Phone className="text-sky-600 mr-3" size={20} />
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-sky-600 text-white px-6 py-3 rounded-lg hover:bg-sky-700 transition"
            >
              Send Message
            </button>
          </form>
